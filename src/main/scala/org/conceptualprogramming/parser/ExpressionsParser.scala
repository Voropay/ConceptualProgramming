...
trait ExpressionsParser extends ConstantsParser {
  def expression: Parser[CPExpression] = objectExpression | mapExpression | listExpression | unaryOperatorExpression | operatorExpression | constantExpression |
                                         functionCallExpression | getFromCollectionExpression | attributeExpression | childObjectExpression | variableExpression | subExpression
  ...
  def childObjectExpression: Parser[CPChildObject] = "$" ~ ident ^^ {value => new CPChildObject(value._2)}
  ...
  def collectionExpression = attributeExpression | childObjectExpression | variableExpression | subExpression
}

 ...
 */
case class CPDivOperation(operand1: CPDependencyExpression, operand2: CPDependencyExpression) extends CPDependencyExpression {
  ...
  override def equals(other: Any) = {
    other match {
      case other: CPDivOperation => operand1 == other.operand1 && operand2 == other.operand2
      case _ => false
    }
  }
}